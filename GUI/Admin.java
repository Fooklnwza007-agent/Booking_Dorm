...
public class Admin extends javax.swing.JFrame {
    ...
    // unified file directory for easier maintenance
    ...
    public Admin() {
        ...
        // loadCSV(requestModel, FILE_DIR + "requests.csv");
        loadDormList(); // load
    }

    private void loadDormList() {
        String filePath = FILE_DIR + "dormlist.csv";
    ...
    private void initComponents() {
        ...
        BackToRequets = new javax.swing.JButton();
        ...
        requestTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "room", "Username", "Firstname", "Lastname", "phone num.", "Email", "statas"
                }) {
        ...
        userTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "room", "Username", "Firstname", "Lastname", "phone num.", "Email"
                }) {
            boolean[] canEdit = new boolean[] {
        ...
        BackToRequets.setText("BacktoRequests");
        BackToRequets.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BackToRequetsActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 472,
                                        Short.MAX_VALUE)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 504,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(29, 29, 29))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(41, 41, 41)
                                ...
                                .addGap(91, 91, 91)
                                .addComponent(DormSelect, javax.swing.GroupLayout.PREFERRED_SIZE,
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(100, 100, 100)
                                .addComponent(Approve, javax.swing.GroupLayout.PREFERRED_SIZE, 99,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(64, 64, 64)
                                .addComponent(Reject, javax.swing.GroupLayout.PREFERRED_SIZE, 101,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(82, 82, 82)
                                .addComponent(save_to_csv)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(BackToRequets)
                                .addGap(69, 69, 69)
                                .addComponent(Approve1, javax.swing.GroupLayout.PREFERRED_SIZE, 99,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(171, 171, 171)));
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(adminText, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 278,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 47,
                                                        Short.MAX_VALUE)
                                                .addGroup(jPanel1Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(Approve1, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                45, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(Reject, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                45, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(Approve, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                45, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(save_to_csv,
    ...
    private void ApproveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ApproveActionPerformed
        ...
        if (selected != -1) {
            String room = requestModel.getValueAt(selected, 0).toString();
            String username = requestModel.getValueAt(selected, 1).toString();
            String firstname = requestModel.getValueAt(selected, 2).toString();
            String lastname = requestModel.getValueAt(selected, 3).toString();
            String phone = requestModel.getValueAt(selected, 4).toString();
            String email = requestModel.getValueAt(selected, 5).toString();

            // เพิ่มไป userTable
            UserModel.addRow(new Object[] { room, username, firstname, lastname, phone, email });
    ...
    private void Approve1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_Approve1ActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            // Optionally save changes to CSV immediately
            saveCSV(UserModel, FILE_DIR + "User_admin.csv");
    ...
    private void DormSelectActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_DormSelectActionPerformed
        ...
        if (selectedDorm != null && !selectedDorm.isEmpty()) {
            String fileName = FILE_DIR + "requests_"
    ...
    private javax.swing.JButton BackToRequets;
