...
public class RoomAdmin extends javax.swing.JFrame {
    ...
    public RoomAdmin() {
        ...
        // 🔹 เพิ่ม TableRowSorter
        sorter = new javax.swing.table.TableRowSorter<>(RoomModel);
...
if (result == JOptionPane.OK_OPTION) {
    ...
    RoomModel.addRow(new Object[]{roomId, ""});
    ...
    if (roomName != null) {
        ...
        for (int i = 0; i < RoomModel.getRowCount(); i++) {
            if (RoomModel.getValueAt(i, 0).toString().equalsIgnoreCase(roomName)) {
                JOptionPane.showMessageDialog(this, "This room already exists!");
                return;
            }
        }
    ...
    // ดึงชื่อห้องและหอ
    String roomId = RoomModel.getValueAt(selectedRow, 0).toString();
    String dormName = (String) DormSelect.getSelectedItem();
    if (dormName == null || dormName.trim().isEmpty()) {
        JOptionPane.showMessageDialog(this, "Dorm not selected!");
        return;
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        ...
        // บันทึกไป CSV ของหอที่เลือก
        saveRoomCSV(dormName);

        JOptionPane.showMessageDialog(this, "Room " + roomId + " deleted!");
    }
