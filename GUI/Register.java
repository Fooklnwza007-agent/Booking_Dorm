...
public class Register extends javax.swing.JFrame {
        ...
        private void jB_RegisterActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jB_RegisterActionPerformed
                ...
                if (Username.isEmpty() || Email.isEmpty() || Password.isEmpty() || comfirmPassword.isEmpty()
                                || phone.isEmpty()) { // if not fill all
                        JOptionPane.showMessageDialog(this, "Please complete all fields.", "WARNING",
                ...
                if (comfirmPassword.length() < 8) {
                        JOptionPane.showMessageDialog(this, "ComfirmPassword must at least 8 characters.", "WARNING",
                                        JOptionPane.WARNING_MESSAGE);
                        return;
                }

                if (!Password.equals(comfirmPassword)) {
                        JOptionPane.showMessageDialog(this, "Passwords do not match.", "WARNING",
                                        JOptionPane.WARNING_MESSAGE);
                        return;
                }

                if (!phone.matches("\\d+")) {
                        JOptionPane.showMessageDialog(this, "Please enter numbers only.", "WARNING",
                                        JOptionPane.WARNING_MESSAGE);
                        return;
                }
                ...
                try (java.io.FileWriter fw = new java.io.FileWriter(filePath, true)) { // true = append mode
                        fw.write(Username + "," + Email + "," + phone + "," + gender + "," + Password + "\n");
                        JOptionPane.showMessageDialog(this, "Register Successful! Saved to User_password.csv");

                        // เคลียร์ช่องทั้งหมดหลังบันทึก
                        t1.setText("");
                        t2.setText("");
                        t5.setText("");
                        p1.setText("");
